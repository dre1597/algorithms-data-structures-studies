...
describe('DoublyLinkedList', () => {
  describe('getByIndex', () => {
    it('should get by index', () => {
      ...
      expect(list.toString()).toBe(
        'any_data1 any_data2 any_data3 any_data4 any_data5',
      );
  ...
  describe('unshift', () => {
    it('should add to front', () => {
      ...
      expect(list2.toString()).toBe(
        'any_data any_data1 any_data2 any_data3 any_data4 any_data5',
      );
    });
  });
  ...
  describe('push', () => {
    it('should add to back', () => {
      ...
      expect(list2.size).toBe(6);
      expect(list2.toString()).toBe(
        'any_data1 any_data2 any_data3 any_data4 any_data5 any_data',
      );
    });
  });
  ...
  describe('add', () => {
    it('should add to index', () => {
      ...
      expect(list3.toString()).toBe(
        'any_data1 any_data2 any_data any_data3 any_data4 any_data5',
      );

      const list4 = generateNonEmptyList();
      expect(list4.toString()).toBe(
        'any_data1 any_data2 any_data3 any_data4 any_data5',
      );
  ...
  describe('shift', () => {
    it('should remove from front', () => {
      ...
      expect(list2.toString()).toBe(
        'any_data2 any_data3 any_data4 any_data5 any_data',
      );
    });
